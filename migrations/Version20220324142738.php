 ...
 */
final class Version20220324142738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage CHANGE enreprise_id enreprise_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage CHANGE enreprise_id enreprise_id INT DEFAULT NULL');
    }
}
